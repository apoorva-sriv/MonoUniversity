...
function getName(){
    rl.question('Enter a name  ', (answer) => {name = answer; getPrice();});
}

function getPrice(){
    rl.question('Enter a Price  ', (answer) => {price = parseInt(answer); getImg();});
}

function getImg(){
    rl.question('Enter Image URL  ', (answer) => {img = answer; getDesc();});
}
